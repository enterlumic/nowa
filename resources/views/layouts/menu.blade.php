...
<li class="slide">
    <a href="productos" class="side-menu__item">
        <i class="material-icons side-menu__icon">local_offer</i>
        <span class="side-menu__label">Productos</span>
    </a>
</li>
<li class="slide">
    <a href="carrito" class="side-menu__item">
        <i class="material-icons side-menu__icon">shopping_cart</i>
        <span class="side-menu__label">Carrito</span>
    </a>
</li>
<li class="slide">
    <a href="cliente_conekta" class="side-menu__item">
...
<li class="slide has-sub">
    ...
    <ul class="slide-menu child1">
        ...
        <li class="slide">
            <a href="marcas" class="side-menu__item">Marcas</a>
        </li>
