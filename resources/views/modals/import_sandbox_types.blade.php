@php
    ...
    function import_sandbox_types(){}
@endphp

<div id="modalImportFormsandboxTypes" class="modal fade" tabindex="-1" aria-labelledby="modalImportFormsandboxTypesLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalImportFormsandboxTypesLabel">Cargar datos</h5>
                ...
                <div class="tab-content p-3">
                    <div class="tab-pane active" id="tab-importar-excel" role="tabpanel">
                        <div class="live-preview row">
                           <a href="descargar_plantilla_sandbox_types" class="btn btn-soft-success">
                                <i class="typcn typcn-download"></i> 
                                Descargar plantilla
                            </a>
                        </div>
                        <form action="form_importar_sandbox_types" id="FormImportarsandboxTypes" name="FormImportarsandboxTypes" >
                    ...
                    <div class="tab-pane" id="tab-copiar-pegar" role="tabpanel">
                        <form action="#form_import_sandbox_types" id="form_import_sandbox_types" method="post" class="form-material form-action-post justify-content-center" >
