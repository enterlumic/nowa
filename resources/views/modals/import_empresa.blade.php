@php
    ...
    function import_empresa(){}
@endphp

<div id="modalImportFormempresa" class="modal fade" tabindex="-1" aria-labelledby="modalImportFormempresaLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalImportFormempresaLabel">Cargar datos</h5>
                ...
                <div class="tab-content p-3">
                    <div class="tab-pane active" id="tab-importar-excel" role="tabpanel">
                        <div class="live-preview row">
                           <a href="descargar_plantilla_empresa" class="btn btn-soft-success">
                                <i class="typcn typcn-download"></i> 
                                Descargar plantilla
                            </a>
                        </div>
                        <form action="form_importar_empresa" id="FormImportarempresa" name="FormImportarempresa" >
                    ...
                    <div class="tab-pane" id="tab-copiar-pegar" role="tabpanel">
                        <form action="#form_import_empresa" id="form_import_empresa" method="post" class="form-material form-action-post justify-content-center" >
