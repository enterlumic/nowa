@php
    ...
    function import_logss(){}
@endphp

<div id="modalImportFormlogss" class="modal fade" tabindex="-1" aria-labelledby="modalImportFormlogssLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalImportFormlogssLabel">Cargar datos</h5>
                ...
                <div class="tab-content p-3">
                    <div class="tab-pane active" id="tab-importar-excel" role="tabpanel">
                        <div class="live-preview row">
                           <a href="descargar_plantilla_logss" class="btn btn-soft-success">
                                <i class="typcn typcn-download"></i> 
                                Descargar plantilla
                            </a>
                        </div>
                        <form action="form_importar_logss" id="FormImportarlogss" name="FormImportarlogss" >
                    ...
                    <div class="tab-pane" id="tab-copiar-pegar" role="tabpanel">
                        <form action="#form_import_logss" id="form_import_logss" method="post" class="form-material form-action-post justify-content-center" >
