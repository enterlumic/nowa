@php
    ...
    function import_carrito(){}
@endphp

<div id="modalImportFormcarrito" class="modal fade" tabindex="-1" aria-labelledby="modalImportFormcarritoLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalImportFormcarritoLabel">Cargar datos</h5>
                ...
                <div class="tab-content p-3">
                    <div class="tab-pane active" id="tab-importar-excel" role="tabpanel">
                        <div class="live-preview row">
                           <a href="descargar_plantilla_carrito" class="btn btn-soft-success">
                                <i class="typcn typcn-download"></i> 
                                Descargar plantilla
                            </a>
                        </div>
                        <form action="form_importar_carrito" id="FormImportarcarrito" name="FormImportarcarrito" >
                    ...
                    <div class="tab-pane" id="tab-copiar-pegar" role="tabpanel">
                        <form action="#form_import_carrito" id="form_import_carrito" method="post" class="form-material form-action-post justify-content-center" >
