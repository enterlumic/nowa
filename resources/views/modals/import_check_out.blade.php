@php
    ...
    function import_check_out(){}
@endphp

<div id="modalImportFormcheckOut" class="modal fade" tabindex="-1" aria-labelledby="modalImportFormcheckOutLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalImportFormcheckOutLabel">Cargar datos</h5>
                ...
                <div class="tab-content p-3">
                    <div class="tab-pane active" id="tab-importar-excel" role="tabpanel">
                        <div class="live-preview row">
                           <a href="descargar_plantilla_check_out" class="btn btn-soft-success">
                                <i class="typcn typcn-download"></i> 
                                Descargar plantilla
                            </a>
                        </div>
                        <form action="form_importar_check_out" id="FormImportarcheckOut" name="FormImportarcheckOut" >
                    ...
                    <div class="tab-pane" id="tab-copiar-pegar" role="tabpanel">
                        <form action="#form_import_check_out" id="form_import_check_out" method="post" class="form-material form-action-post justify-content-center" >
