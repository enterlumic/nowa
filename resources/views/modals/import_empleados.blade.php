@php
    ...
    function import_empleados(){}
@endphp

<div id="modalImportFormempleados" class="modal fade" tabindex="-1" aria-labelledby="modalImportFormempleadosLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalImportFormempleadosLabel">Cargar datos</h5>
                ...
                <div class="tab-content p-3">
                    <div class="tab-pane active" id="tab-importar-excel" role="tabpanel">
                        <div class="live-preview row">
                           <a href="descargar_plantilla_empleados" class="btn btn-soft-success">
                                <i class="typcn typcn-download"></i> 
                                Descargar plantilla
                            </a>
                        </div>
                        <form action="form_importar_empleados" id="FormImportarempleados" name="FormImportarempleados" >
                    ...
                    <div class="tab-pane" id="tab-copiar-pegar" role="tabpanel">
                        <form action="#form_import_empleados" id="form_import_empleados" method="post" class="form-material form-action-post justify-content-center" >
