...
bubbleChartColors && (bubbleChartWidth = $("#bubble-charts").width(), container = document.getElementById("bubble-charts"), data = {
 ...
 chart : {
   ...
   format : function $(query, expr, context, undefined) {
     return "r" !== undefined && "x" !== undefined || (query = tui.chart.renderUtil.formatToComma(query), "x" === undefined && (query = "$" + query)), query;
   }
 },
 yAxis : {
 ...
 tooltip : {
   template : function check(call, item) {
     return '<div class="tui-chart-default-tooltip"><div class="tui-chart-tooltip-head"><span class="tui-chart-legend-rect" style="' + item.cssText + '; width: 10px; height: 10px"></span><span>' + item.legend + "</span><span>" + item.label + '</span></div><table class="tui-chart-tooltip-body"><tr><td>GDP</td><td class="tui-chart-tooltip-value">' + item.x + '</td></tr><tr><td>Life Expectancy</td><td class="tui-chart-tooltip-value">' + item.y + '</td></tr><tr><td>Population</td><td class="tui-chart-tooltip-value">' +
     item.r + "</td></tr></table>";
   }
 }
}, theme = {
...
scatterChartColors && (scatterChartWidth = $("#scatter-charts").width(), container = document.getElementById("scatter-charts"), data = {
 ...
 tooltip : {
   template : function render($, $$) {
     return '<div class="tui-chart-default-tooltip"><div class="tui-chart-tooltip-head">' + $$.legend + '</div><table class="tui-chart-tooltip-body"><tr><td>Weight</td><td class="tui-chart-tooltip-value">' + $$.x + 'kg</td></tr><tr><td>Height</td><td class="tui-chart-tooltip-value">' + $$.y + "cm</td></tr></table></div>";
   }
 }
}, theme = {
 chart : {
...
donutPieChartColors && (donutpieChartWidth = $("#donut-charts").width(), container = document.getElementById("donut-charts"), data = {
 ...
 chart : {
   ...
   height : 380,
   title : "Usage share of web browsers",
   format : function init(mod, version, app, component, mws) {
     return "makingSeriesLabel" === app && (mod = mod + "%"), mod;
   }
 },
 series : {
   radiusRange : ["40%", "100%"],
