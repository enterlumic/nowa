...
find . -path ./storage -prune -o -path ./vendor -prune -o -path ./.git -prune -o -iname "*productos*" | while read file; do
  path=$(dirname "$file")
...
find . -path ./storage -prune -o -path ./vendor -prune -o -path ./.git -prune -o -type f -name "*" | while read file; do
